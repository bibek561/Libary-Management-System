...
<body>
	...
	<span><marquee>This is library mangement system. Library opens at 8:00 AM and close at 12:00 PM</marquee></span><br><br>
...
<?php
	if(isset($_POST['issue_book']))
	{
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"lms");
		$query = "insert into issued_books(book_no, book_name, book_author, student_id, issue_date, status) values($_POST[book_no],'$_POST[book_name]','$_POST[book_author]',$_POST[user],'$_POST[issue_date]',1)";
		$query_run = mysqli_query($connection,$query);
		// echo $query;
